...
SECRET_KEY = '-wk8sm0&l+u=3i8!zy0@qfdqjgm*b++qyv3u#w3vzq*8p+cuhj'
...
AWS_STORAGE_BUCKET_NAME = 'my-django-twitter'
...
# use `sudo apt-get install memcached` -> 安装memcached
# use `pip install python-memcached` -> python和memcached进行沟通
CACHES = {
    'default': {
