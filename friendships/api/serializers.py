...
class FollowerSerializer(serializers.ModelSerializer):
    ...
    def get_has_followed(self, obj):
        if self.context['request'].user.is_anonymous:
            return False
        return FriendshipService.get_has_followed(self.context['request'].user, obj.from_user)
...
class FollowingSerializer(serializers.ModelSerializer):
    ...
    def get_has_followed(self, obj):
        if self.context['request'].user.is_anonymous:
            return False
        return FriendshipService.get_has_followed(self.context['request'].user, obj.to_user)
